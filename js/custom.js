...
function indicator(){
  if(getLoudestFrequency(selected[3],selected[4])<selected[2] && getLoudestFrequency(selected[3],selected[4])>selected[1]){
    ...
    text('>',65,50);
  }else if (selected[5]!== 0 ) { //if the frequency is not correct.
    fill(255);
    text(selected[5],150,50);
    if(getLoudestFrequency(selected[3],selected[4])>selected[2]){ //change color of the arror
      fill(220,53,69);
      text('<',235,50);
      fill(255);
      text('>',65,50);
    }else if (getLoudestFrequency(selected[3],selected[4])<selected[1]) { //change color of the arror
      fill(255);
      text('<',235,50);
      fill(220,53,69);
      text('>',65,50);
